package com.example.usm.musicplayer.Activity;
...
import com.example.usm.musicplayer.Adapter.ViewPagerAdapter;
import com.example.usm.musicplayer.DB.FavoritesOperations;
...
import com.example.usm.musicplayer.R;
import com.example.usm.musicplayer.Services.MyServices;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    private void changecolor() {
        ViewPager view = findViewById(R.id.songs_viewpager);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_btn_replay:
                ImageButton imageButton = findViewById(R.id.img_btn_replay);
                if (repeatFlag) {
                    ...
                    imageButton.setColorFilter(Color.CYAN);
            ...
            case R.id.img_btn_setting:
                ImageButton imageButton1 = findViewById(R.id.img_btn_setting);
                if (playContinueFlag) {
                    imageButton1.setColorFilter(Color.WHITE);
                    playContinueFlag = false;
                    Toast.makeText(this, "Loop Removed", Toast.LENGTH_SHORT).show();
                } else {
                    imageButton1.setColorFilter(Color.CYAN);
